            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6">
                    ...
                    <div class="card mt-4">
                        <div class="card-header">
                            <h6 class="mb-0">
                                <i class="fas fa-question-circle me-2"></i>Creating Effective Categories
                            </h6>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li><i class="fas fa-check text-success me-2"></i>Keep names concise but informative</li>
                                        <li><i class="fas fa-check text-success me-2"></i>Use consistent naming conventions</li>
                                        <li><i class="fas fa-check text-success me-2"></i>Avoid overly specific categories</li>
                                    </ul>
                                </div>
                                <div class="col-md-6">
                                    <h6>Examples:</h6>
                                    <ul class="list-unstyled">
                                        <li><i class="fas fa-tag text-primary me-2"></i>Pain Relief</li>
                                        <li><i class="fas fa-tag text-primary me-2"></i>Vitamins & Supplements</li>
                                        <li><i class="fas fa-tag text-primary me-2"></i>First Aid</li>
                                        <li><i class="fas fa-tag text-primary me-2"></i>Personal Care</li>
                                    </ul>
                                </div>
                            </div>
                        </div>

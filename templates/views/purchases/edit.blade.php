    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Edit Purchase #{{ $purchase->id }}</h4>
            </div>
        </div>
    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div id="purchaseItems">
                                    ...
                                    <div class="purchase-item border rounded p-3 mb-3" data-item-id="{{ $item->id }}">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-6 offset-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="totalAmount" name="total_amount" value="{{ $purchase->total_amount }}" readonly>
                                </div>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Load suppliers and set current value
    loadSuppliers();
...
function loadProducts(itemIndex, selectedProductId = null, selectedPrice = null) {
    ...
    .then(data => {
        ...
        if (productSelect) {
            ...
            if (selectedPrice) {
                const priceInput = productSelect.closest('.purchase-item').querySelector('.price-input');
                if (priceInput) {
...
function submitPurchase() {
    ...
    fetch('/api/v1/purchases/{{ $purchase->id }}', {
        method: 'PUT',
        headers: {
            'Accept': 'application/json',
    ...
    .then(data => {
        if (data.success) {
            ...
            showAlert(data.message || 'Error updating purchase', 'danger');
        }
    })
    .catch(error => {
        console.error('Error:', error);
        showAlert('Error updating purchase', 'danger');
    });
}
...
function showAlert(message, type) {
    ...
    document.querySelector('.card-body').insertBefore(alertDiv, document.getElementById('purchaseForm'));
